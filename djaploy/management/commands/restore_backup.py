...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if backend == "borg":
            ...
            if target == "local":
                ...
                self._handle_server_borg(options, config, inventory_dir, target, host_name)
        else:
            ...
            if target == "local":
                ...
                self._handle_server_rclone(options, config, inventory_dir, target, host_name)
    ...
    def _handle_server_borg(self, options, config, inventory_dir, target, host_name):
    ...
    def _handle_server_rclone(self, options, config, inventory_dir, target, backup_host_name):
